...
| --- | --- | --- | --- | --- |
| 1.20.1 | Fabric Loader 0.19.3+（无前置模组） | 17、21、25 | `1.20.1` | 构建通过；Java 21、25 独立服务端启动、加载 McBot 与正常关服由 CI 验证 |
| 1.20.1 | Forge 47.4.22—47.x | 17、21、25 | `1.20.1` | 构建通过；Java 21、25 独立服务端启动、加载 McBot 与正常关服由 CI 验证 |
