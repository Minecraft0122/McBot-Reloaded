...
| Minecraft | 加载器 | Java | 分支 | 3.0.2 状态 |
| --- | --- | --- | --- | --- |
| 1.20.1 | Fabric Loader 0.16.9+（无前置模组） | 17+ | `1.20.1` | 已通过独立服务端启动、关服、测试与完整构建 |
| 1.20.1 | Forge 47.3.12—47.x | 17+ | `1.20.1` | 已通过测试与完整构建 |
| 1.21.1 | Fabric Loader 0.16.10+（无前置模组） | 21+ | `1.21.1` | 已通过独立服务端启动、关服、测试与完整构建 |
| 1.21.1 | NeoForge 21.1.84 或兼容的 21.1.x | 21+ | `1.21.1` | 已通过测试与完整构建 |

自动发布会从两个正式版本分支构建四个可安装 JAR，并汇总到同一个 GitHub Release。文件名形如 `McBot-1.20.1-3.0.2-fabric.jar`；不同 Minecraft 版本和加载器的 JAR 不能混用。
