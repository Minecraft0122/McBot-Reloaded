...
## [3.0.4](https://github.com/Minecraft0122/McBot-Reloaded/releases/tag/3.0.4) - 2026-07-29

- 从 Forge/NeoForge 成品内置的 Jupiter 中移除上游测试示例类，保留平台入口、网络同步和配置界面，首次启动不再生成无关的 `config/jupiter.json` 或记录读取异常。
